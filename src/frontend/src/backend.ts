...
export class Backend implements backendInterface {
    ...
    async getOrCreatePlayer(): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getScore(arg0: Principal): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async shoot(arg0: Principal): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.shoot(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
